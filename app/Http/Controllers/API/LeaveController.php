   ...
   public function Add_leave(Request $request)
    {
        ...
        //echo json_encode($request->details);exit;
        ...
        $data1 = Leave::orderBy('id','DESC')->first();
   ...
   public function Delete_Sticky(Request $request)
    ...
    public function Get_leave(Request $request)
    {
       ...
       if($user_type == "Admin"){
           ...
           $data=Leave::with('userdetails')->with('user:id,email')->orderBy('id','desc')->get();
           
       }else{
           $data=Leave::with('userdetails')->with('user:id,email')->where('user_id',$user_id)->orderBy('id','desc')->get();
       }
