...
@section('main-content')
    ...
    <div class="text-uppercase font-small"><?php if(isset($_GET['month']) && $_GET['month']!="")echo date('M', mktime(0, 0, 0, $_GET['month']+1));else echo date('M , Y');?></div>
                                    ...
                                    <?php $i=1; foreach ($data['employees'] as $row){ ?>
                                        <tr>
                                            ...
                                            <td><?php if(isset($_GET['month']) && $_GET['month']!="") 
                                                            $status = Paymentstatus::where('user_id',$row->id)->whereMonth('created_at',$_GET['month']+1)->first();
                                                      else
                                                            $status = Paymentstatus::where('user_id',$row->id)->whereMonth('created_at',Carbon::now()->month)->first();
