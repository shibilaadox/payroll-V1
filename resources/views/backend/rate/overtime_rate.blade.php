...
@section('main-content')
    <div class="col-md-12 mb-4">
        <div class="card text-left">
            <div class="card-body">
                <h4 class="mb-3 fs-22 font-weight-bold">Overtime Rates
                    ...
                    <a class="btn btn-bold btn-label-brand btn-sm" style="float:right;margin-right: 1%;margin-bottom: 2%"
                        href="<?php echo url('') . '/assets/format/ot_rates.xls'; ?>" target="_blank"> <button
                            class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">Download
                            template</button></a>

                    
                </h4>
                <p class="fs-16">All Your Overtime Rates</p>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 1</th>
                                           
                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 2</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 3</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 4</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 5</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 6</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 7</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 8</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 9</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 10</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 11</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 12</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Rate 13</th>
                                    </thead>
                                    <tbody>
    ...
    <div class="modal fade" id="modal_excel_deduction" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('import_overtime_rate.excel') }}" method="POST" enctype="multipart/form-data">
