...
@section('main-content')
    <div class="col-md-12 mb-4">
        <div class="card text-left">
            <div class="card-body">
                <h4 class="mb-3 fs-22 font-weight-bold">SSS Rates
                    ...
                    <a class="btn btn-bold btn-label-brand btn-sm" style="float:right;margin-right: 1%;margin-bottom: 2%"
                        href="<?php echo url('') . '/assets/format/sss_table.xls'; ?>" target="_blank"> <button
                            class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">Download
                            template</button></a>

                    
                </h4>
                <p class="fs-16">All Your SSS Rates</p>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Limit</th>
                                           
                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Emplr</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Emply</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Ecc</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Emprov</th>

                                                <th class="sorting_asc" tabindex="0" aria-controls="deduction_datatable"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 181.002px;">Erprov</th>
                                    </thead>
                                    <tbody>
    ...
    <div class="modal fade" id="modal_excel_deduction" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('import_sss_rate.excel') }}" method="POST" enctype="multipart/form-data">
