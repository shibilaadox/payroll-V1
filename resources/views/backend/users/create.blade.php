        ...
        <div class="row mb-12">
            ...
            <form action="{{ route('employee.store') }}" method="POST" class="needs-validation">
                    ...
                    <div class="col-lg-12">
                                        ...
                                        <div class="form-row col-md-12">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail1" class="ul-form__label">
                                                    ...
                                                    <input type="text" class="form-control" id="employee_code" placeholder="Employee Code"
                                                    name="employee_code" readonly>
                                            </div>
                        ...
                        <td>
                            <input type="text" class="form-control to_date" name="to_date[]" id="to_date">
                        </td>
                        <td>
                            <input type="text" class="form-control" name="job_description[]" id="job_description">
                        </td>
                        <td>
                            <button type="button" class="btn btn-sm btn-default btn-icon m-1 attr" id="experience_add">
                                <span class="ul-btn__icon"><i class="i-Add"
                                        style="font-size: 20px;"></i></span>
                            </button>
                        </td>
                        <input type="hidden" class="form-control" name="work_experience" id="work_experience">
                    </tr>
                </tbody>
             </table>
             ...
             <div style="margin-bottom:20px;;margin-top:20px;">
                        ...
                        <td>
                            <input type="text" class="form-control date_of_completion" name="date_of_completion[]" id="date_of_completion">
                        </td>
                       
                        <td>
                            <button type="button" class="btn btn-sm btn-default btn-icon m-1 attr" id="education_add">
                                <span class="ul-btn__icon"><i class="i-Add"
                                        style="font-size: 20px;"></i></span>
                            </button>
                        </td>
                        <input type="hidden" class="form-control" name="education_details" id="education_details">
                    </tr>
                </tbody>
             </table>
                        ...
                        <td>
                            <button type="button" class="btn btn-sm btn-default btn-icon m-1 attr" id="emergency_add">
                                <span class="ul-btn__icon"><i class="i-Add"
                                        style="font-size: 20px;"></i></span>
                            </button>
                        </td>
                        <input type="hidden" class="form-control" name="emergency" id="emergency">
                    </tr>
                </tbody>
             </table>
                                    ...
                                    <h6 style="font-size:15px;" class="card-title"><b>Seperation Information</b></h6>
                                        ...
                                        placeholder="Enter Reason for Leaving" name="reason_for_leaving"></textarea>
                                            </div>
                                    ...
                                    <div class="form-row col-md-12">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="annual_ctc" id="annual_ctc">&nbsp;&nbsp;&nbsp;per year
                                            </div>
                                            </div>
                                    ...
                                    <tbody id="salary_row">
                                    <tr>
                                        <td><h6 style="font-size:15px;" class=""><b>Earnings</b></h6></td>
                                    </tr>
                                    <tr>
                        ...
                        <td>
                        <div class="input-group mb-3">
                                                <input type="text" class="form-control" name="basic_salary_per" id="basic_salary_per" value=50>
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">&nbsp;% of CTC</span>
                                                </div>
                                            </div>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="monthly_basic" id="monthly_basic" readonly>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="annual_basic" id="annual_basic" readonly>
                        </td>
                    ...
                    <tr>
                        ...
                        <label for="inputEmail1" class="ul-form__label">House Rent Allowance</label>
                        </td>
                        <td>
                        <div class="input-group mb-3">
                                                <input type="text" class="form-control" name="house_rent_per" id="house_rent_per" value=50>
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">&nbsp;% of Basic</span>
                                                </div>
                                            </div>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="monthly_house_rent" id="monthly_house_rent" readonly>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="annual_house_rent" id="annual_house_rent" readonly>
                        </td>
                    ...
                    <tr>
                        ...
                        <label for="inputEmail1" class="ul-form__label">Conveyance Allowance</label>
                        </td>
                        <td>
                        <label for="inputEmail1" class="ul-form__label">Fixed</label>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="monthly_conveyance" id="monthly_conveyance" value=0>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="annual_conveyance" id="annual_conveyance" readonly value=0>
                        </td>
                    ...
                    <tr>
                        ...
                        <label for="inputEmail1" class="ul-form__label">Fixed Allowance</label>
                        </td>
                        <td>
                        <label for="inputEmail1" class="ul-form__label">Fixed</label>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="monthly_fixed" id="monthly_fixed" readonly>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="annual_fixed" id="annual_fixed" readonly>
                        </td>
                    ...
                    <tr style="background-color: #cfebeb;">
                        ...
                        <label for="inputEmail1" class="ul-form__label"><b>Cost to Company<b></label>
                        </td>
                        <td>
                       
                        </td>
                        <td>
                        <label for="inputEmail1" class="ul-form__label" id="monthly_cost"></label>
                        </td>
                        <td>
                        <label for="inputEmail1" class="ul-form__label" id="annual_cost"></label>
                        </td>
...
<script type="text/javascript">
    ...
    $("#save").mouseover(function() {
        ...
        for (var i = 0; i <company_names.length; i++) {
            ...
            var work_experience = new WorkExperience(company_name.value, job_title.value ,from_date.value,to_date.value,job_description.value);
        ...
        for (var i = 0; i <institution_names.length; i++) {
            ...
            var education_details = new EducationDetails(institution_name.value, degree.value ,specialization.value,date_of_completion.value);
